...
{ // Field multiplication, c = a*b mod (2^127-1)
    // uint128_t tt1, tt2, tt3, tt4, tt5 = {0};
    
// #if defined(UINT128_SUPPORT)
//     tt1 = (uint128_t)a[0]*b[0];
//     tt2 = (uint128_t)a[1]*b[1];
//     tt3 = (uint128_t)a[0] + a[1];
//     tt4 = (uint128_t)b[0] + b[1];
//     tt5 = (uint128_t)tt3 * tt4 - tt1 - tt2 + (uint64_t)(tt1 >> 64);
//     tt3 = (uint128_t)tt2 * 2 + ((uint128_t)tt5 >> 63);
//     tt1 = (uint64_t)tt1 | ((uint128_t)((uint64_t)tt5 & mask63) << 64);
//     tt1 += tt3;
